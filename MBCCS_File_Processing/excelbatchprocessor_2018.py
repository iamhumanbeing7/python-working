...
i = 0
for file_2018 in files_2018:
    i += 1
    file_2018_path = os.path.join(path_2018, file_2018)
    print(file_2018)
    excelbook = open_workbook(file_2018_path)
    var_cruise_info = ''
    var_resource1 = "SA"
    ...
    for sheet in excelbook.sheets():
        ...
        if sheet.name.upper() == 'MAIN':
        ...
        elif sheet.name.upper().strip() == 'SHEET3':
            ...
            for cell in sheet_apo_sa_col:
                ...
                if SA_IND:
                    ...
                    var_resource2_qty += 1
        elif sheet.name.upper().strip() == 'SHEET1':
    ...
    #     print("DatabaseError error: {0}".format(exception))
        ...
        print('{0} cannot be processed due to Exception : {1}'.format(file_2018, commonexception))
    # i += 1
        try:
            cursor.execute(None,
                           FILE_NAME=file_2018,
            ...
            print('{0} Only file name and exception information are persisted.'.format(file_2018))
            # shutil.copy(file_2018_path, path_2018_error)
